...
class CoveragePlanner:
    ...
    BASE_RETURN_MARGIN = 14.0
    NPC_RETURN_MARGIN = 12.0
    RETURN_RETRY_MARGIN = 6.0
    LOW_BATTERY_RATIO = 0.26
    ...
    NARROW_PENALTY = 1.2
    NPC_BLOCK_RADIUS = 2
    CHARGER_PATH_TRIGGER_RATIO = 0.45
    CHARGER_REPLAN_INTERVAL = 25
    BLOCKED_CELL_TTL = 8
    ...
    def _select_explore_target(
        ...
        for z, x in candidate_coords:
            ...
            if expansion_phase:
                ...
                score += (2.4 if not charger_known and is_frontier else (1.5 if is_frontier else 0.0))
