...
def build_monitor():
    ...
    config_dict = (
        ...
        .end_panel()
        .add_panel(name="Avg Invalid Move Rate", name_en="avg_invalid_move_rate", type="line")
        .add_metric(metrics_name="avg_invalid_move_rate", expr="avg(avg_invalid_move_rate{})")
        .end_panel()
        .add_panel(name="Avg Charge Efficiency", name_en="avg_charge_efficiency", type="line")
