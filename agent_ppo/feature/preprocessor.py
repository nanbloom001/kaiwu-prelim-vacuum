    ...
    def _arrival_confirm_params(self, arrival_order: int) -> dict:
        if arrival_order <= 0:
            return {
                ...
                "final_left_observed": 20,
                "final_battery_gain": 0.08,
                "candidate_scale": 0.35,
            }
        if arrival_order == 1:
            return {
        ...
        return {
            ...
            "final_min_delay": 120,
            "final_deadline": 200,
            "candidate_coverage": 6,
            "candidate_observed": 44,
            "candidate_left_coverage": 4,
            "final_coverage": 10,
            "final_observed": 64,
            "final_left_coverage": 5,
            "final_left_observed": 32,
            "final_battery_gain": 0.12,
    ...
    def _resolve_pending_arrivals(
        ...
        *,
        ...
        for region_key, info in list(self.pending_arrivals.items()):
            ...
            severe_risk = (
                is_starving
                or (charge_active and charge_loop_flag and not left_region)
                or (charge_active and self.charge_loop_frames >= 6)
