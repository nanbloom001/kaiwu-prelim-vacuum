...
class Preprocessor:
    ...
    def pb2struct(self, env_obs, last_action):
        ...
        self.max_step = int(env_info.get("max_step", 2000))

        # Legal actions / 合法动作
        self._legal_act = [int(x) for x in (observation.get("legal_act") or observation.get("legal_action") or [1] * 8)]
    ...
    def _get_global_state_feature(self):
        ...
        """
        step_norm = _norm(self.step_no, max(self.max_step, 1))
