...
class Config:
    ...
    SAMPLE_TEACHER_MASK_DIM = SEQ_CHUNK_LEN
    ...
    MODE_TEACHER_WEIGHT = 0.05
    TARGET_TEACHER_WEIGHT = 0.05
    AUX_BATTERY_RISK_WEIGHT = 0.05
    AUX_COLLISION_RISK_WEIGHT = 0.05
    TEACHER_FORCE_UNTIL_EPISODE = 80
    TEACHER_ANNEAL_END_EPISODE = 220
    ...
    ASTAR_POTENTIAL_BATTERY_THRESHOLD = 0.80
    ...
    EXPERT_EMERGENCY_BATTERY_RATIO = 0.05
    ...
    # None for the first LTSPPO line: train from scratch
