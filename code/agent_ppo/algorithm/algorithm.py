...
class CoveragePlanner:
    ...
    BASE_RETURN_MARGIN    = 16.0  # 触发返回充电的电量余量：battery <= charger_distance + 16 时开始返回
    NPC_RETURN_MARGIN     = 20.0  # 充电路径经过 NPC 风险区时额外增加的安全余量（避免路途中碰撞）
    LOW_BATTERY_RATIO     = 0.26  # 电量比低于此值时强制返回充电桩（应对充电桩距离估算误差）
